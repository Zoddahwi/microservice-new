package com.victorwiseactive.productservice;
...
//				.andExpectAll(status().isOk(), (ResultMatcher) content().json(productResponseString));
		Assertions.assertNotNull(productResponseString);
//
	}
